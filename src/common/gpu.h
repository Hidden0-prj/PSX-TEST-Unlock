...
// Bumped from 2048 to 4096 to comfortably fit a full frame of menu text
// plus the Matrix rain background (which is drawn as many small font
// glyph quads) without risking overrun of a single frame's packet chain.
